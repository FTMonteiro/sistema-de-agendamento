...
const socialButtonClass =
  "group flex h-[50px] w-full items-center justify-center gap-3 rounded-[12px] border border-neutral-200 bg-white text-[13px] font-medium text-neutral-800 transition-all duration-300 hover:border-neutral-300 hover:bg-neutral-50 active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-blue-500/10";
  ...
  return (
    <main className="min-h-screen bg-white text-neutral-950">
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <section className="relative hidden min-h-screen overflow-hidden bg-[#05070b] lg:flex">
          <div
            aria-hidden="true"
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 opacity-[0.035] bg-[linear-gradient(rgba(255,255,255,.8)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.8)_1px,transparent_1px)] bg-[size:52px_52px]"
          />
          ...
          <div className="relative z-10 flex w-full flex-col px-10 py-9 xl:px-16">
            ...
            <p className="text-[9px] tracking-wide text-slate-700">
              © {new Date().getFullYear()} NEVRIX. Todos os
              direitos reservados.
            </p>
          </div>
        </section>
          ...
          <div className="relative z-10 w-full max-w-[430px]">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-[13px] leading-6 text-neutral-500">
                Crie a sua conta para começar a utilizar a
                NEVRIX.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-5">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2.5 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                  >
                    {showPassword ? (
                      <EyeOff size={16} />
                    ) : (
              ...
              <button
                ...
                className="group relative mt-6 flex h-[51px] w-full items-center justify-center gap-2 overflow-hidden rounded-[12px] bg-[#050505] text-[13px] font-semibold text-white shadow-[0_8px_25px_rgba(0,0,0,0.12)] transition-all duration-300 hover:bg-blue-600 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <span
                  aria-hidden="true"
